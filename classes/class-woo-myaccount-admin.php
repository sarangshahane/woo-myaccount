...
class Woo_Myaccount_Admin {
	...
	public static function init_hooks() {
		...
		include_once CARTFLOWS_DIR . 'classes/class-woo-myaccount-admin-fields.php';
	...
	static function submenu() {
		...
		$parent_slug = MY_ACCOUNT_SLUG;
		$page_title  = __( 'Settings', 'woo-myaccount' );
		$menu_title  = __( 'Settings', 'woo-myaccount' );
		$capability  = 'manage_options';
		$menu_slug   = 'woo_myaccount_settings';
